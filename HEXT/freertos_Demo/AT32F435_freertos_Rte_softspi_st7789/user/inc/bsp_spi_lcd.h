...
#define LCD_SCLK_Clr() gpio_bits_reset(GPIOA,GPIO_PINS_5)//SCL=SCLK
#define LCD_SCLK_Set() gpio_bits_set(GPIOA,GPIO_PINS_5)

#define LCD_MOSI_Clr() gpio_bits_reset(GPIOB,GPIO_PINS_5)//SDA=MOSI
#define LCD_MOSI_Set() gpio_bits_set(GPIOB,GPIO_PINS_5)
