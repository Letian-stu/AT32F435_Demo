...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE  (12U * 1024U) //(48U * 1024U)          /*[bytes]*/
 ...
 */
#define LV_LAYER_SIMPLE_BUF_SIZE            (3 * 1024)//(24 * 1024)
...
#define LV_DISP_ROT_MAX_BUF (5*1024)//(10*1024)
